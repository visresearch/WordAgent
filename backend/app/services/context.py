...
LIGHT_COMPACT_PROTECT_TOKENS = _get_env_int("WORDAGENT_LIGHT_COMPACT_PROTECT_TOKENS", 20000)
LIGHT_COMPACT_MIN_TOOL_RESULTS = _get_env_int("WORDAGENT_LIGHT_COMPACT_MIN_TOOL_RESULTS", 5)
