export default {
  ...
  chat: {
    ...
    agentPlaceholder: '描述下一步要构建的内容', askPlaceholder: '输入要咨询的问题',
    chooseModel: '请选择模型', deleteParagraphs: '删除 {count} 个段落', aiOperation: 'AI 修订：{actions}（待确认）',
    ...
    deletePreview: '删除 {ids}', generatedPending: '生成 {summary}',
    ...
    paragraphCount: '{count} 个段落', tableCount: '{count} 个表格', summarySeparator: '、', actionSeparator: '，', pendingAddition: '待添加内容',
    input: {
