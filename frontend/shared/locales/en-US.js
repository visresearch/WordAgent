export default {
  ...
  chat: {
    ...
    agentPlaceholder: 'Describe what to build next', askPlaceholder: 'Enter a question',
    chooseModel: 'Select a model', deleteParagraphs: 'deleted {count} paragraphs', aiOperation: 'AI revisions: {actions} (pending confirmation)',
    ...
    deletePreview: 'Delete {ids}', generatedPending: 'generated {summary}',
    ...
    paragraphCount: '{count} paragraphs', tableCount: '{count} tables', summarySeparator: ', ', actionSeparator: ', ', pendingAddition: 'Pending addition',
    input: {
