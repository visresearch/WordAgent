export default {
  ...
  chat: {
    ...
    chooseModel: 'Select a model', deleteParagraphs: 'Delete {count} paragraphs', aiOperation: 'AI operation: {actions}',
    ...
    deletePreview: 'AI is ready to delete paragraphs (paraIDs: {ids})', generatedPending: 'AI generated {summary}; awaiting confirmation',
