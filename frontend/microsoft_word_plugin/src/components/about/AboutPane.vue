  ...
  <div class="about-container">
    <div class="about-content">
      ...
      <div class="project-info">
        ...
        <h1 class="project-name">文策AI助手</h1>
        <p class="project-subtitle">WenCe AI Assistant</p>
      </div>
      ...
      <div class="info-section">
        ...
        <div class="info-item">
          ...
          <span class="info-value">Microsoft Word 加载项</span>
        </div>
        <div class="info-item">
      ...
      <div class="links-section">
        <h3>🔗 相关链接</h3>
        <div class="link-list">
          <a href="https://github.com/visresearch/WordAgent" target="_blank" class="link-item">
          ...
          <a href="https://github.com/visresearch/WordAgent/issues" target="_blank" class="link-item">
            <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
