...
from app.models.chat import ModelsResponse, ModelInfo
...
async def get_models():
    ...
    try:
        ...
        return ModelsResponse(
            success=True,
            models=[
                ModelInfo(id="auto", name="Auto", provider="WenCe AI", description="自动选择最佳模型")
            ]
        )
...
async def refresh_models():
    ...
    return {
        "success": True,
        "message": f"已刷新，共 {len(models)} 个可用模型"
    }