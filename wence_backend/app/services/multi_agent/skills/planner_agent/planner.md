...
- **outline**: 读取已有文档内容、搜索文档中的特定内容，生成写作大纲。工具: read_document, query_document
- **writer**: 根据收集到的资料和大纲，撰写完整的 Word 文档。工具: generate_document
...
## 模式二：基于文档修改（润色、翻译、扩写等）
1. writer: 根据用户要求修改文档（writer 会自行读取原文）
