...
魔搭社区在[MCP广场](https://www.modelscope.cn/mcp)中有大量现成的 MCP 服务器可以直接使用。
...
| fetch | 一个提供网页内容抓取功能的模型上下文协议服务器 | https://www.modelscope.cn/mcp/servers/@modelcontextprotocol/fetch | ✅ | ✅ |
